  ...
  territorios: any[] = [
    {
      ...
      mapas: [
        {
          'img_0': 'assets/maps/pq-novo-mundo-maps-1',
          'img_1': 'assets/maps/pq-novo-mundo-potencialidades',
          'img_2': 'assets/maps/pq-novo-mundo-problematica',
          'img_3': 'assets/maps/pq-novo-mundo-sintese',
          'img_4': 'assets/maps/pq-novo-mundo-zoneamento'
        }
      ],
      carrossel_territorios: [
        {
          img: 'assets/carrosel/territorio-1',
          caption: 'Visão aérea do Parque Novo Mundo no entorno do CEU. Fonte: SMSU/DTS/Dronepol '
        },
        {
          img: 'assets/carrosel/territorio-2',
          caption: 'Favela da Funerária localizada na Av. Ernesto Augusto Lopes. Fonte: SMUL.'
        },
        {
          img: 'assets/carrosel/territorio-3',
          caption: 'Ação de plantio no CEU, junto com a ONG Formigas de Embaúba. Fonte: SUGi/Tuane Fernandes.'
        },
        {
          img: 'assets/carrosel/territorio-4',
          caption: 'Entrada do CEU Parque Novo Mundo. Fonte: SECOM.'
        }
      ],
      carrossel_atividades: [
        {
          img: 'assets/carrosel/acao-1',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/acao-2',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/acao-3',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/acao-4',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/acao-5',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/acao-6',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/acao-7',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/acao-8',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        }
      ]
    },
    {
      ...
      carrossel_territorios: [
        {
          img: 'assets/carrosel/MAPA05_Perímetro-Jd_Pantanal.svg',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/MAPA15_PROBLEMÁTICAS-JARDIM_PANTANAL.svg',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/MAPA16_POTENCIALIDADES-JARDIM_PANTANAL.svg',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/FASE-01-PANTANAL_page-0001',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        },
        {
          img: 'assets/carrosel/FASE-01-PANTANAL_page-0002.svg',
          caption: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac cursus justo.'
        }
      ],
      carrossel_atividades: [
